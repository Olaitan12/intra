...
class AppDecoration {
  ...
  static BoxDecoration get textstylepoppinsmedium161 => BoxDecoration(
  ...
  static BoxDecoration get textstylepoppinsregular104 => BoxDecoration(
        color: ColorConstant.amber5004c,
        borderRadius: BorderRadius.circular(
          getHorizontalSize(
            30.00,
          ),
  ...
  static BoxDecoration get textstylepoppinsregular106 => BoxDecoration(
  ...
  static BoxDecoration get textstylepoppinsregular105 => BoxDecoration(
        color: ColorConstant.red5004c,
        borderRadius: BorderRadius.circular(
          getHorizontalSize(
            30.00,
          ),
  ...
  static BoxDecoration get textstylepoppinsmedium166 => BoxDecoration(
  ...
  static BoxDecoration get textstylepoppinsmedium165 => BoxDecoration(
        color: ColorConstant.purple800,
        borderRadius: BorderRadius.circular(
          getHorizontalSize(
            4.00,
  ...
  static BoxDecoration get textstylepoppinsbold201 => BoxDecoration(
  ...
  static BoxDecoration get textstylepoppinsbold12 => BoxDecoration(
        color: ColorConstant.whiteA700,
        borderRadius: BorderRadius.circular(
          getHorizontalSize(
            4.00,
  ...
  static BoxDecoration get groupstylepurple1 => BoxDecoration(
        color: ColorConstant.purple800,
        borderRadius: BorderRadius.circular(
          getHorizontalSize(
            24.00,
  ...
  static BoxDecoration get textstylepoppinsregular127 => BoxDecoration(
        borderRadius: BorderRadius.circular(
          getHorizontalSize(
            8.00,
          ),
  ...
  static BoxDecoration get textstylepoppinssemibold162 => BoxDecoration(
        color: ColorConstant.purple80063,
        borderRadius: BorderRadius.circular(
          getHorizontalSize(
            8.00,
          ),
  ...
  static BoxDecoration get groupstylepurple800cornerradius => BoxDecoration(
        color: ColorConstant.purple800,
        borderRadius: BorderRadius.circular(
          getHorizontalSize(
            16.00,
  ...
  static BoxDecoration get groupstylepurple300cornerradius => BoxDecoration(
  ...
  static BoxDecoration get groupstylewhiteA700F2 => BoxDecoration(
        color: ColorConstant.whiteA700F2,
      );
  static BoxDecoration get groupstylegray8007acornerradius => BoxDecoration(
