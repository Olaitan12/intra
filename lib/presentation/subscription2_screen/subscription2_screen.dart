import '../subscription2_screen/widgets/group135_item_widget.dart';
...
class Subscription2Screen extends GetWidget<Subscription2Controller> {
  @override
                                          ...
                                          child: Obx(
                                            () => CarouselSlider.builder(
                                              ...
                                              itemCount: controller
                                                  .subscription2ModelObj
                                                  .value
                                                  .group135ItemList
                                                  .length,
                                              itemBuilder:
                                                  (context, index, realIndex) {
                                                Group135ItemModel model =
                                                    controller
                                                        .subscription2ModelObj
                                                        .value
                                                        .group135ItemList[index];
                                                return Group135ItemWidget(
                                                  model,
                                                );
                                              },
                                            ),
